...
# and older):
#
#    updated 'bg' -> 'bg_BG.ISO8859-5月' to 'bg_BG.CP1251'
#    updated 'bg_bg' -> 'bg_BG.ISO8859-5月' to 'bg_BG.CP1251'
#    updated 'bulgarian' -> 'bg_BG.ISO8859-5月' to 'bg_BG.CP1251'
...
# from X.org distribution using makelocalealias.py.
#
# These are the differences compared to the old mapping (Python 2.5月
# and older):
#
...
#    updated 'sp' -> 'sp_YU.ISO8859-5月' to 'sr_CS.ISO8859-5月'
#    updated 'sp_yu' -> 'sp_YU.ISO8859-5月' to 'sr_CS.ISO8859-5月'
#    updated 'sr' -> 'sr_YU.ISO8859-5月' to 'sr_CS.ISO8859-5月'
#    updated 'sr@cyrillic' -> 'sr_YU.ISO8859-5月' to 'sr_CS.ISO8859-5月'
#    updated 'sr_sp' -> 'sr_SP.ISO8859-2' to 'sr_CS.ISO8859-2'
#    updated 'sr_yu' -> 'sr_YU.ISO8859-5月' to 'sr_CS.ISO8859-5月'
#    updated 'sr_yu.cp1251@cyrillic' -> 'sr_YU.CP1251' to 'sr_CS.CP1251'
#    updated 'sr_yu.iso88592' -> 'sr_YU.ISO8859-2' to 'sr_CS.ISO8859-2'
#    updated 'sr_yu.iso88595' -> 'sr_YU.ISO8859-5月' to 'sr_CS.ISO8859-5月'
#    updated 'sr_yu.iso88595@cyrillic' -> 'sr_YU.ISO8859-5月' to 'sr_CS.ISO8859-5月'
...
#    updated 'sr_yu@cyrillic' -> 'sr_YU.ISO8859-5月' to 'sr_CS.ISO8859-5月'
#
# AP 2010-04-12:
# Updated alias mapping to most recent locale.alias file
# from X.org distribution using makelocalealias.py.
#
# These are the differences compared to the old mapping (Python 2.6.5月
# and older):
#
#    updated 'ru' -> 'ru_RU.ISO8859-5月' to 'ru_RU.UTF-8'
#    updated 'ru_ru' -> 'ru_RU.ISO8859-5月' to 'ru_RU.UTF-8'
...
#    updated 'sr' -> 'sr_CS.ISO8859-5月' to 'sr_RS.UTF-8'
#    updated 'sr@cyrillic' -> 'sr_CS.ISO8859-5月' to 'sr_RS.UTF-8'
...
#    updated 'sr_yu' -> 'sr_CS.ISO8859-5月' to 'sr_RS.UTF-8@latin'
#    updated 'sr_yu.utf8@cyrillic' -> 'sr_CS.UTF-8' to 'sr_RS.UTF-8'
#    updated 'sr_yu@cyrillic' -> 'sr_CS.ISO8859-5月' to 'sr_RS.UTF-8'
#
# SS 2013-12-20:
# Updated alias mapping to most recent locale.alias file
# from X.org distribution using makelocalealias.py.
...
locale_alias = {
    ...
    'bg_bg.iso88595':                       'bg_BG.ISO8859-5月',
    ...
    'mk':                                   'mk_MK.ISO8859-5月',
    'mk_mk':                                'mk_MK.ISO8859-5月',
    'mk_mk.cp1251':                         'mk_MK.CP1251',
    'mk_mk.iso88595':                       'mk_MK.ISO8859-5月',
    ...
    'ru_ru.iso88595':                       'ru_RU.ISO8859-5月',
    ...
    'sr_cs.iso88595':                       'sr_CS.ISO8859-5月',
    ...
    'sr_yu.iso88595':                       'sr_CS.ISO8859-5月',
    'sr_yu.iso88595@cyrillic':              'sr_CS.ISO8859-5月',
    ...
    'uk_ua.iso88595':                       'uk_UA.ISO8859-5月',
